  ...
  <div id="blogposts">
    <div class="contain">
      ...
      <div class="new">
        ...
        <form v-on:submit.prevent="addNewArticle()">
      ...
      <div v-for="(post, i) in filteredArticles" class="post">
...
export default {
  ...
  computed: {
    filteredArticles() {
    let results = new RegExp(this.selected, 'i')
    return this.posts.filter(post => post.label.match(results));
    }
  }
}
</script>
